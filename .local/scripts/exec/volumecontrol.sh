...
icodir="/home/tuthanh/.config/dunst/icons/vol"
step=5
# Parse options
while getopts "iop:st" opt; do
    case $opt in
        ...
        s) select_output "$(select_output | rofi -p "Choose sink: " -theme-str 'textbox-prompt-colon {str: "";}' -dmenu -config "~/.config/rofi/notification.rasi")"; exit ;;
